								...
								<?php if ($orders->have()) : ?>
									<?php while ($orders->next()) : ?>
										<tr id="<?php $orders->id() ?>">
											...
											<td><a href="<?php $options->adminUrl('extending.php?panel=..%2Fthemes%2F' . urlencode(THEME_NAME) . '%2Fadmin%2Ffriends.php&action=edit&id=') . $orders->id() ?>"><?php $orders->title() ?></a> <i class="i-edit"></i></td>
