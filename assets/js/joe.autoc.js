    ...
    _createClass(AutocJs, [{
        ...
        value: function renderOutsideOutline() {
            ...
            elements.switcher = dom.createElement('div', {
                className: 'joe_action_item outline-outside-switcher'
            }, [dom.createElement('i', {
            ...
            document.getElementsByClassName('joe_action')[0].appendChild(elements.switcher);
        ...
        value: function addListeners() {
            ...
            if (position === 'outside') {
                delegate(document.getElementsByClassName('joe_action')[0], '.outline-outside-switcher', 'click', this._handleSwitcherClick, this);
        ...
        value: function _handleChapterClick(evt) {
            ...
            var dom = utils.DOM;
            var events = utils.Events;
            var offsetTop = dom.offset(heading).top - height - 20;
