                            ...
                            <a target="_blank" rel="noopener noreferrer nofollow" class="joe_live__list-item animate__animated animate__bounceIn" href="${window.location.href + '?profileRoom=' + _.profileRoom + '&title=' + _.nick}">
                                ...
                                <div class="description">
                                    <div class="avatar">
                                        ...
                                        <img onerror="Joe.avatarError(this)" width="25" height="25" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="${_.avatar180}" alt="${_.nick}"/>
                                    </div>
                                    <div class="nick">${_.nick}</div>
                                    <p class="mb0 introduction">${_.introduction}</p>
                                    <div class="meta">
