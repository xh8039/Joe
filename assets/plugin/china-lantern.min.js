...
<div class="lantern__warpper" style="left:50px;">
	<div class="lantern__box">
		<div class="lantern__line"></div>
		<div class="lantern__circle">
			<div class="lantern__ellipse">
				<div class="lantern__text">${texts[0]}</div>
			</div>
		</div>
		<div class="lantern__tail">
			<div class="lantern__rect">
			</div>
			<div class="lantern__junction"></div>
		</div>
	</div>
</div>
<div class="lantern__warpper" style="left:150px;">
	<div class="lantern__box">
		<div class="lantern__line"></div>
		<div class="lantern__circle">
			<div class="lantern__ellipse">
				<div class="lantern__text">${texts[1]}</div>
			</div>
		</div>
		<div class="lantern__tail">
			<div class="lantern__rect">
...
<div class="lantern__warpper lantern__secondary" style="right:150px;">
	<div class="lantern__box">
		<div class="lantern__line"></div>
		<div class="lantern__circle">
			<div class="lantern__ellipse">
				<div class="lantern__text">${texts[2]}</div>
			</div>
		</div>
		<div class="lantern__tail">
...
<div class="lantern__warpper lantern__secondary" style="right:50px;">
	<div class="lantern__box">
		<div class="lantern__line"></div>
		<div class="lantern__circle">
			<div class="lantern__ellipse">
				<div class="lantern__text">${texts[3]}</div>
			</div>
		</div>
		<div class="lantern__tail">
			<div class="lantern__rect"></div>
