...
?>
	...
	<script src="<?= joe\theme_url('assets/plugin/jquery/3.6.0/jquery.min.js') ?>"></script>
	<script src="<?= joe\theme_url('assets/plugin/layer/3.5.1/layer.min.js') ?>"></script>
	<script>
		window.Joe = {
