...
while ($this->next()) :
	...
	if ($this->fields->mode == "default" || !$this->fields->mode) : ?>
		<li class="joe_list__item wow default">
			...
			<div class="information">
				<a href="<?= joe\permalink($this->permalink) ?>" class="title" title="<?php $this->title() ?>" target="<?php $this->options->Jsearch_target() ?>" rel="noopener noreferrer">
					<?php $this->title() ?>
				</a>
				<a class="abstract" href="<?= joe\permalink($this->permalink) ?>" title="文章摘要" target="<?php $this->options->Jsearch_target() ?>" rel="noopener noreferrer"><?php joe\getAbstract($this) ?></a>
				<div class="meta">
					...
					<div class="item-meta muted-2-color flex jsb ac">
						...
						<div class="meta-right">
							<item class="meta-comm">
								<a rel="nofollow" data-toggle="tooltip" title="去评论" href="<?= joe\permalink($this->permalink) ?>?scroll=comment_module">
	...
	<?php elseif ($this->fields->mode == "single") : ?>
		<li class="joe_list__item wow single">
			<div class="line"></div>
			<div class="information">
				<a href="<?= joe\permalink($this->permalink) ?>" class="title" title="<?php $this->title() ?>" target="_blank" rel="noopener noreferrer">
					<?php $this->title() ?>
				</a>
				<div class="meta">
					<div class="item-tags scroll-x no-scrollbar mb6"><?= joe\get_archive_tags($this) ?></div>
			...
			<div class="information" style="margin-bottom: 0;">
				<a class="abstract" href="<?= joe\permalink($this->permalink) ?>" title="文章摘要" target="_blank" rel="noopener noreferrer"><?php joe\getAbstract($this) ?></a>
			</div>
		</li>
