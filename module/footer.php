		...
		<div class="container fluid-widget">
			<div class="links-widget mb20">
				<div class="links-box links-style-simple zib-widget">
					...
					$friends_page_slug = Typecho\Router::url('page', $friends_page['slug']);
					?>
					<a class="icon-spot" href="<?= Typecho\Common::url($friends_page_slug, $this->options->index) ?>.html">查看更多</a>
				</div>
			</div>
		</div>
	<?php endif;
...
<?php if (!empty($this->options->NewYearLantern)) : ?>
	<script src="<?= joe\theme_url('assets/plugin/china-lantern.min.js', ['text' => $this->options->NewYearLantern]); ?>"></script>
<?php endif; ?>
