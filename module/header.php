...
<header class="joe_header <?php echo $this->is('post') ? 'current' : '' ?>">
	...
	<div class="joe_header__above">
		<div class="joe_container">
			...
			<a title="<?php $this->options->title(); ?>" class="joe_header__above-logo" href="<?php $this->options->siteUrl(); ?>">
				<img data-src="<?php empty($this->options->JLogo) ? $this->options->themeUrl('assets/images/logo.png') : $this->options->JLogo ?>" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="<?php $this->options->title(); ?>" class="lazyload" />
	...
	<div class="joe_header__slideout">
		<img class="joe_header__slideout-image" height="<?php $this->options->JAside_Wap_Image_Height ? $this->options->JAside_Wap_Image_Height() : print_r('150px'); ?>" src="<?= $this->options->JAside_Wap_Image ? $this->options->JAside_Wap_Image : joe\theme_url('assets/images/wap_aside_image.jpg') ?>" alt="侧边栏壁纸" />
