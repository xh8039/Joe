		...
		<div class="container-fluid container-header">
			<div class="navbar-header">
				<div class="navbar-brand">
					<a referrerpolicy="no-referrer" rel="noreferrer" class="navbar-logo" href="<?php $this->options->siteUrl() ?>"><img src="<?php empty($this->options->JLogo) ? $this->options->themeUrl('assets/images/logo.png') : $this->options->JLogo(); ?>" switch-src="<?php $this->options->JDarkLogo(); ?>" alt="<?= $this->options->title ?>" class="<?= $this->options->JLogo_Light_Effect == 'on' ? 'joe_scan_light' : null ?>"></a>
				</div>
										...
										<div class="sub-user-box">
											...
											<div class="em09 author-tag mb10 mt6 flex jc">
												<a class="but c-blue tag-posts" data-toggle="tooltip" title="共<?= $PostsNum ?>篇文章" href="<?php $this->user->permalink() ?>">
													<svg class="icon svg" aria-hidden="true"><use xlink:href="#icon-post"></use></svg><?= $PostsNum ?>
												</a>
												<a class="but c-green tag-comment" data-toggle="tooltip" title="共<?= $CommentsNum ?>条评论" href="<?php $this->options->adminUrl('manage-comments.php') ?>">
													<svg class="icon svg" aria-hidden="true"><use xlink:href="#icon-comment"></use></svg><?= $CommentsNum ?>
												</a>
												...
												<span class="badg c-red tag-view" data-toggle="tooltip" title="人气值 <?= $views ?>">
													<svg class="icon svg" aria-hidden="true"><use xlink:href="#icon-hot"></use></svg><?= $views ?>
												</span>
											</div>
											...
											<div class="mt10 text-center">
												<div class="flex jsa header-user-href">
													<a rel="nofollow" href="<?php $this->options->adminUrl('profile.php') ?>">
														<div class="badg mb6 toggle-radius c-blue"><svg style="transform: translate(1px, -50%)" class="icon svg" aria-hidden="true" data-viewBox="50 0 924 924" viewBox="50 0 924 924"><use xlink:href="#icon-user"></use></svg></div>
													...
													<a href="<?php $this->options->logoutUrl(); ?>">
														<div class="badg mb6 toggle-radius c-red"><svg class="icon svg" aria-hidden="true"><use xlink:href="#icon-signout"></use></svg></div>
												...
												?>
													<div class="flex jsa header-user-href">
														<a rel="nofollow" target="_blank" href="<?php $this->options->adminUrl('options-theme.php') ?>">
															<div class="badg mb6 toggle-radius c-yellow"><svg class="icon svg" aria-hidden="true"><use xlink:href="#icon-theme"></use></svg></div>
														...
														<a rel="nofollow" target="_blank" href="<?php $this->options->adminUrl() ?>">
															<div class="badg mb6 toggle-radius c-yellow"><svg class="icon svg" aria-hidden="true"><use xlink:href="#icon-set"></use></svg>
															</div>
