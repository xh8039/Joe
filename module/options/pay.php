...
$JYiPayApi = new \Typecho\Widget\Helper\Form\Element\Text(
	'JYiPayApi',
	NULL,
	'http://ypay.yihang.info/',
	'易支付/码支付API接口网址',
	'介绍：用于文章付费阅读功能 <br />
	例如：http://mpay.yihang.info/ <br />
	易航易支付：<a href="http://ypay.yihang.info?key=RbgwH8wQ4Vkx" target="_blank">http://ypay.yihang.info</a> <br />
	易航码支付：<a href="http://mpay.yihang.info?key=RbgwH8wQ4Vkx" target="_blank">http://mpay.yihang.info</a>'
);
...
$JYiPayID = new \Typecho\Widget\Helper\Form\Element\Text(
	...
	'介绍：用于文章付费阅读功能 <br />
	例如：1001 <br />
	<a href="http://ypay.yihang.info?key=RbgwH8wQ4Vkx" target="_blank">注册易支付商户号</a>丨<a href="http://mpay.yihang.info?key=RbgwH8wQ4Vkx" target="_blank">注册码支付商户号</a>
	'
);
...
$JYiPayKey = new \Typecho\Widget\Helper\Form\Element\Text(
	...
	<a href="http://ypay.yihang.info?key=RbgwH8wQ4Vkx" target="_blank">注册易支付商户密钥</a>丨<a href="http://mpay.yihang.info?key=RbgwH8wQ4Vkx" target="_blank">注册码支付商户密钥</a>
	'
);
