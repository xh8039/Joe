		...
		<div class="comment-list__item-contain" id="<?php $comments->theId(); ?>">
			<div class="term">
				...
				<div class="content">
					...
					?>
					<div class="substance" data-trigger="hover" data-placement="top" data-content="<?= joe\getAgentOS($comments->agent) ?>&nbsp;·&nbsp;<?= joe\getAgentBrowser($comments->agent) ?>&nbsp;·&nbsp;<?= joe\dateWord($comments->dateWord) ?>" <?= joe\isMobile() ? 'data-toggle="popover"' : null ?>>
