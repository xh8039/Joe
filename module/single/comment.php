...
?>
	<li class="comment-list__item">
		<div class="comment-list__item-contain" id="<?php $comments->theId(); ?>">
			<div class="term">
				<?php
				$mobile_handle = joe\isMobile() ? 'data-placement="right" data-trigger="hover" data-content="' . joe\getAgentOS($comments->agent) . '&nbsp;·&nbsp;' . joe\getAgentBrowser($comments->agent) . '&nbsp;·&nbsp;' . joe\dateWord($comments->dateWord) . '" data-toggle="popover"' : null;
				if ($comments->request->getHeader('x-pjax') == 'true') {
				?>
