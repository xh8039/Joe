...
<div class="joe_detail__copyright">
	<div class="content">
		...
		<div class="item">
			...
			<span>本文链接：</span><span class="text"><a class="link" href="<?= joe\root_relative_link($this->permalink) ?>" target="_blank" rel="noopener noreferrer nofollow"><?= $this->permalink ?></a></span>
		</div>
		<div class="item">
			<svg class="icon" width="20" height="20" viewBox="0 0 1024 1024">
