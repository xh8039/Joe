		...
		<div id="think_page_trace_tab_cont" style="overflow:auto;height:calc(50vh - 38px);padding:0;line-height: 24px">
			<div style="display:none;">
				<ol style="padding: 0; margin:0">
					...
					?>
					<li style="border-bottom:1px solid #EEE;font-size:14px;padding:0 12px"><?= "运行时间 : {$execution_time}s [ 吞吐率：{$throughput}req/s ] 内存消耗：{$memory_usage_kb}kb 文件加载：{$file_loads}个" ?></li>
