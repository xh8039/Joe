...
$JPrismTheme = new Typecho_Widget_Helper_Form_Element_Select(
	...
	array(
		...
		'prism-coy-without-shadows.min.css' => 'prism-coy-without-shadows',
		...
		'prism-gruvbox-light.min.css' => 'prism-gruvbox-light',
		'prism-holi-theme.min.css' => 'prism-holi-theme',
		...
		'prism-one-dark.min.css' => 'prism-one-dark（默认）',
		'prism-one-light.min.css' => 'prism-one-light',
		'prism-pojoaque.min.css' => 'prism-pojoaque',
		'prism-shades-of-purple.min.css' => 'prism-shades-of-purple',
		'prism-solarized-dark-atom.min.css' => 'prism-solarized-dark-atom',
		...
		'prism-z-touch.min.css' => 'prism-z-touch',
