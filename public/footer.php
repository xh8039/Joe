...
?>
	...
	<script src="<?= Joe::jsdelivrUrl('public/js/Meting.js'); ?>"></script>
<?php
}
...
<footer class="joe_footer">
	...
	if ($this->options->JFooter_Fish == 'on') {
        echo '<div id="footer_fish"></div><script src="'. Joe::jsdelivrUrl('public/js/FooterFish.js') .'"></script>';
	}
	?>
</footer>
...
<div class="joe_action">
	...
	<div class="joe_action_item full_screen">
        <svg class="icon-1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
